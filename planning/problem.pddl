(define (problem twenty-four-puzzle)
  ...
  (:init
    ...
    (tile-at tile10 row1 col1)	  
    (tile-at tile12 row1 col2)
    (tile-at tile2 row1 col3)	  
    (tile-at tile3 row1 col4)
    (tile-at tile9 row1 col5)	  
    
    (tile-at tile21 row2 col1)
    (tile-at tile20 row2 col2)	  
    (tile-at tile4 row2 col3)
    (tile-at tile16 row2 col4)	  
    (tile-at tile14 row2 col5)
   	
   	(tile-at tile11 row3 col1)	  
   	(tile-at tile17 row3 col2)
    (tile-at tile23 row3 col3)	  
    (tile-at tile5 row3 col4)
    (tile-at tile15 row3 col5)	
      
    (tile-at tile22 row4 col1)
    (tile-at tile19 row4 col2)	  
    (tile-at tile13 row4 col3)
    (tile-at tile7 row4 col4)	  
    (tile-at tile8 row4 col5)
    
    (tile-at tile18 row5 col1)	  
    (tile-at tile1 row5 col2)
    (tile-at tile6 row5 col3)	  
    (tile-at tile24 row5 col4)
    (is-blank row5 col5)
